...
function init()
	...
	robot.wheels.set_velocity(left_v,right_v) --'robot 'similar to 'this', not defined in this file
	n_steps = 0
...
function step()
	...
	light_front = robot.light[1].value + robot.light[24].value -- sum frontal light sensor, the sensor give 0 < x < 1
